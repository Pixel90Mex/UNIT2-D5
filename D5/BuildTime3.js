...
function searchJob(work, geo){

  let job = work.toLowerCase();
  let loc = geo.toLowerCase();

  let result = [];

  for(let element of jobs) {
    
    let location = element.location.toLocaleLowerCase();
    let title = element.title.toLowerCase();

    if(location.includes(loc) && title.includes(job)){
...
//console.log(searchJob('Customer Service', 'US'));
let oggetto = searchJob("Customer Service", "US");

console.log(oggetto.risultato);
console.log(oggetto.count);
